...
* **Маршрутизатор границы автономной системы (Autonomous System Boundary Router, ASBR)**. ASBR — это маршрутизатор, который имеет интерфейсы, подключенные к одной или нескольким областям OSPF, аналогично ABR, однако отличие ASBR в том, что он также подключается к другим системам маршрутизации, таким как BGP, EIGRP, Internet и другим. Маршрутизатор ASBR обычно рассылают маршруты из других систем маршрутизации в область OSPF, к которой он принадлежит.
