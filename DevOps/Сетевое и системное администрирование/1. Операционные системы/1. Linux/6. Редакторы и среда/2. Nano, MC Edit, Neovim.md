...
>Понимание модальной архитектуры Vim из [[Synced/DevOps/Сетевое и системное администрирование/1. Операционные системы/1. Linux/6. Редакторы и среда/1. VIM.md | темы VIM]] критично для понимания различий с немодальными редакторами (Nano, MC) и расширенных возможностей Neovim.
...
> Интеграция редакторов с Git и CI/CD — часть [[Synced/DevOps/CI-CD, артефакты, тестирование и DevSecOps/2. Платформы автоматизации/2. GitLab CI-CD/2. Настройка yml конфигурации.md | рабочих процессов GitLab CI]] и [[Synced/DevOps/IaC/7. Governance, CI-CD и автоматизация IaC/1. PR-Driven Infrastructure.md | PR-Driven Infrastructure]].
