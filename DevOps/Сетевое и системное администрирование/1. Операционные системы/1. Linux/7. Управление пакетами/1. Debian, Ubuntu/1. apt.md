...
> 
> - `apt` работает поверх [[2. dpkg| dpkg]] — низкоуровневого менеджера пакетов
> - Источники пакетов настраиваются через [[3. Репозитории| репозитории]]
> - Для продвинутого управления версиями используется [[4. pinning| apt pinning]]
> - Автоматические обновления настраиваются через [[5. unattended-upgrades| unattended-upgrades]]
...
>Подробная работа с репозиториями, включая создание локальных зеркал и прокси — в [[3. Репозитории| управлении репозиториями]].
...
> [!LINK] Связь с IaC
> Детальная работа с Ansible и управление пакетами через роли — в [[1. Роли и Коллекции| ролях Ansible]].
...
> Систематический подход к диагностике проблем с пакетами — часть [[2. Методология Troubleshooting| методологии troubleshooting]].
