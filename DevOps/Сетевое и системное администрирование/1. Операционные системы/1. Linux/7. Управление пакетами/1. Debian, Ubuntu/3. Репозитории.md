...
>`apt-cacher-ng` — это простой прокси-репозиторий. Более мощные решения (Artifactory, Nexus) рассмотрены в [[Synced/DevOps/CI-CD, артефакты, тестирование и DevSecOps/0. Фундаментальные концепции/11. Прокси-репозитории.md | Прокси-репозиториях]].
...
> [!LINK] Связь с CI/CD
> Автоматическая публикация пакетов в репозиторий из CI-пайплайнов — часть [[Synced/DevOps/CI-CD, артефакты, тестирование и DevSecOps/7. Сборка и публикация артефактов/5. Бинарные релизы.md | сборки и публикации артефактов]].
