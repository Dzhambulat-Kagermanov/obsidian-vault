...
> [!LINK] Связь с IaC
> Использование dpkg в Ansible — часть [[Synced/DevOps/IaC/6. Ansible (Продвинутые практики)/1. Роли и Коллекции.md | ролей Ansible]], где управление пакетами часто требуется для настройки серверов.
