...
>[!WARNING] Ограничения Process substitution `<(...)` работает только в bash/zsh, не в POSIX sh. Для переносимых скриптов используйте временные файлы или named pipes.
