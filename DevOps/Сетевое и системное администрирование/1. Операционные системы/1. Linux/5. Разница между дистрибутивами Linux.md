...
>Знание различий дистрибутивов помогает применять [[1. Основы работы в терминале и навигация по ФС| базовые навыки CLI]] и [[4. Bash скрипты| скриптинг]] с учетом особенностей целевой системы, а также правильно использовать [[1. apt| пакетные менеджеры]].
...
>Для критичных систем выбирайте дистрибутивы с [[4. Основы проектирования отказоустойчивой инфраструктуры| гарантированным сроком поддержки]] и четким циклом обновлений. Для dev/test-окружений можно использовать rolling-релизы для раннего доступа к новым версиям инструментов.
...
> Выбор базового образа для Docker напрямую влияет на размер, безопасность и поддерживаемость: детали в [[2. Базовые образы| Базовые образы]].
...
>CMD ["/app"]
>```
>Детали в [[1. Multi-stage builds| Multi-stage builds]].
...
>[!LINK] Связь с IaC
>Написание переносимых Ansible-плейбуков — в [[3. Playbooks| Playbooks]] с использованием условий по `ansible_os_family`.
...
>[!LINK] Связь с CI/CD
>Управление переменными и условиями в пайплайнах — в [[2. Настройка yml конфигурации| настройке yml конфигурации]].
