...
> Диагностика проблем с путями и ссылками — часть [[Synced/DevOps/Сетевое и системное администрирование/0. Введение и методология/2. Методология Troubleshooting.md | методологии диагностики]], особенно при анализе «файл не найден» при наличии файла.
